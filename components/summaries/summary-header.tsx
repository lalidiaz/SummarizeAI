    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          <Badge
            variant="secondary"
            className="text-rose-500 relative px-3 py-1.5 text-sm font-medium bg-white/80 backdrop-blur-xs rounded-full hover:bg-white/90 transition-all duration-200 shadow-xs hover:shadow-md"
          >
 ...
 bg-rose-100 px-2 sm:px-3"
          >
            ...
            <span className="text-xs sm:text-sm text-muted-foreground font-medium ">
              <span className="hide sm:inline">Back to Dashboard</span>
            </span>
          </Button>
        </Link>
      </div>
