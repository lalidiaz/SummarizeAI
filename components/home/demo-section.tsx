...
import { MotionSection, MotionH3, MotionDiv } from "../common/motion-wrapper";
...
export default function DemoSection() {
  return (
    <MotionSection variants={containerVariants} className="relative">
      <div className="py-12 lg:py-14 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        <div
          aria-hidden="true"
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="inline-flex items-center justify-center p-2 rounded-2xl bg-gray-100/80 backdrop-blur-xs border-gray-500/20 mb-4">
            <Wand className="w-6 h-6 text-rose-500" />
          </div>
          <div className="text-center mb-16">
            ...
            >
              Upload a PDF below and watch{" "}
              <span className="bg-linear-to-r from-rose-500 to-rose-700 bg-clip-text text-transparent">
                this Next.js
              </span>{" "}
              app extract key insights instantly with AI
            </MotionH3>
          </div>
          <MotionDiv
            initial={{ opacity: 0 }}
